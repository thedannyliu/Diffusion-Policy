#!/bin/bash
#SBATCH --job-name=ddpm_cube
#SBATCH --output=logs/ddpm_cube_%j.out
#SBATCH --error=logs/ddpm_cube_%j.err
...
# Train DDPM baseline on two_cameras_cube dataset
# Usage: sbatch scripts/train_ddpm_cube.sh [seed]
...
echo "=== Training DDPM Baseline on two_cameras_cube ==="
echo "Seed: $SEED"
