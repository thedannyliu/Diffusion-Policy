#!/bin/bash
#SBATCH --job-name=ddpm_real_sphere
#SBATCH --output=logs/ddpm_real_sphere_%j.out
#SBATCH --error=logs/ddpm_real_sphere_%j.err
...
# === Optimized DDPM Training for Real Robot (Sphere) ===
# Paper-aligned settings for fair comparison with FM
# Usage: sbatch scripts/train_ddpm_real_sphere_optimized.sh [seed]

SEED=${1:-42}

echo "=================================================="
echo "DDPM Real Robot Training - Sphere"
echo "=================================================="
echo "Seed: $SEED"
